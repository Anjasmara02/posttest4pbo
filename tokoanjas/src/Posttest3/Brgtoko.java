...
public class Brgtoko extends Tokosepatu {
    private final String kodeBrg = "Brg";
    private long noKodeBrg ;
    
    Brgtoko(String namaBrg, String satuan, int stokAwal, int stokMasuk, int stokKeluar, int hargaBeli, int hargaJual, long noKodeBrg){
    ...
    Brgtoko Brg;
    ArrayList<Brgtoko> BrgList = new ArrayList<>();
        ...
        while(ulang){
            ...
            if (strHargaJual.equals("0")){
                ...
                try{
                    ...
                    Brg = new Brgtoko(namaBrg, satuan, stokAwal, stokMasuk, stokKeluar, hargaBeli, hargaJual, noKodeBrg); // OBJEK ke - 1
                    BrgList.add(Brg);
    ...
    public ArrayList<Brgtoko> ubahBarang(ArrayList<Brgtoko> Brglist) throws IOException {
        int ubah;
        System.out.println("\t|==================================================|");
        System.out.println("\t|               UBAH BARANG TOKO                   |");
        System.out.println("\t|==================================================|");
        for (int i=0; i<BrgList.size(); i++){
